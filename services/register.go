...
func (r *RegisterService) MakeOrder(req *MakeRegisterOrderReq, commitHash common.Hash) (*models.Register, error) {
	//  verify
...
func (r *RegisterService) GetOrder(commitHash string) (*models.Register, error) {
...
func (r *RegisterService) RefreshURL(commitHash string) (*models.Register, error) {
