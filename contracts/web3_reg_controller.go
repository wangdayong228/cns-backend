...
// CommitmentLabels is a free data retrieval call binding the contract method 0x579d15b1.
//
// Solidity: function commitmentLabels(bytes32 ) view returns(bytes32)
func (_Web3RegisterController *Web3RegisterControllerCaller) CommitmentLabels(opts *bind.CallOpts, arg0 [32]byte) ([32]byte, error) {
	var out []interface{}
	__err := _Web3RegisterController.contract.Call(opts, &out, "commitmentLabels", arg0)
...
//
// Solidity: function commitmentLabels(bytes32 ) view returns(bytes32)
func (_Web3RegisterController *Web3RegisterControllerBulkCaller) CommitmentLabels(bulkcaller bulk.BulkCaller, opts *bind.CallOpts, arg0 [32]byte) (*[32]byte, *error) {

	if opts == nil {
		opts = new(bind.CallOpts)
	}
	__request := _Web3RegisterController.contract.GenRequest(opts, "commitmentLabels", arg0)
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _Web3RegisterController.contract.DecodeOutput(&out, rawOut, "commitmentLabels")
		if err != nil {
			return err
		}
...
//
// Solidity: function commitmentLabels(bytes32 ) view returns(bytes32)
func (_Web3RegisterController *Web3RegisterControllerSession) CommitmentLabels(arg0 [32]byte) ([32]byte, error) {
	return _Web3RegisterController.Contract.CommitmentLabels(&_Web3RegisterController.CallOpts, arg0)
}

// CommitmentLabels is a free data retrieval call binding the contract method 0x579d15b1.
//
// Solidity: function commitmentLabels(bytes32 ) view returns(bytes32)
func (_Web3RegisterController *Web3RegisterControllerCallerSession) CommitmentLabels(arg0 [32]byte) ([32]byte, error) {
	return _Web3RegisterController.Contract.CommitmentLabels(&_Web3RegisterController.CallOpts, arg0)
}
...
// GenCommitHash is a free data retrieval call binding the contract method 0x0fc3a60e.
//
// Solidity: function genCommitHash(bytes32 name, address owner, uint256 duration, bytes32 secret, address resolver, bytes[] data, bool reverseRecord, uint32 fuses, uint64 wrapperExpiry) pure returns(bytes32)
func (_Web3RegisterController *Web3RegisterControllerCaller) GenCommitHash(opts *bind.CallOpts, name [32]byte, owner common.Address, duration *big.Int, secret [32]byte, resolver common.Address, data [][]byte, reverseRecord bool, fuses uint32, wrapperExpiry uint64) ([32]byte, error) {
	var out []interface{}
	__err := _Web3RegisterController.contract.Call(opts, &out, "genCommitHash", name, owner, duration, secret, resolver, data, reverseRecord, fuses, wrapperExpiry)
...
//
// Solidity: function genCommitHash(bytes32 name, address owner, uint256 duration, bytes32 secret, address resolver, bytes[] data, bool reverseRecord, uint32 fuses, uint64 wrapperExpiry) pure returns(bytes32)
func (_Web3RegisterController *Web3RegisterControllerBulkCaller) GenCommitHash(bulkcaller bulk.BulkCaller, opts *bind.CallOpts, name [32]byte, owner common.Address, duration *big.Int, secret [32]byte, resolver common.Address, data [][]byte, reverseRecord bool, fuses uint32, wrapperExpiry uint64) (*[32]byte, *error) {

	if opts == nil {
		opts = new(bind.CallOpts)
	}
	__request := _Web3RegisterController.contract.GenRequest(opts, "genCommitHash", name, owner, duration, secret, resolver, data, reverseRecord, fuses, wrapperExpiry)
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _Web3RegisterController.contract.DecodeOutput(&out, rawOut, "genCommitHash")
		if err != nil {
			return err
		}
...
//
// Solidity: function genCommitHash(bytes32 name, address owner, uint256 duration, bytes32 secret, address resolver, bytes[] data, bool reverseRecord, uint32 fuses, uint64 wrapperExpiry) pure returns(bytes32)
func (_Web3RegisterController *Web3RegisterControllerSession) GenCommitHash(name [32]byte, owner common.Address, duration *big.Int, secret [32]byte, resolver common.Address, data [][]byte, reverseRecord bool, fuses uint32, wrapperExpiry uint64) ([32]byte, error) {
	return _Web3RegisterController.Contract.GenCommitHash(&_Web3RegisterController.CallOpts, name, owner, duration, secret, resolver, data, reverseRecord, fuses, wrapperExpiry)
}

// GenCommitHash is a free data retrieval call binding the contract method 0x0fc3a60e.
//
// Solidity: function genCommitHash(bytes32 name, address owner, uint256 duration, bytes32 secret, address resolver, bytes[] data, bool reverseRecord, uint32 fuses, uint64 wrapperExpiry) pure returns(bytes32)
func (_Web3RegisterController *Web3RegisterControllerCallerSession) GenCommitHash(name [32]byte, owner common.Address, duration *big.Int, secret [32]byte, resolver common.Address, data [][]byte, reverseRecord bool, fuses uint32, wrapperExpiry uint64) ([32]byte, error) {
	return _Web3RegisterController.Contract.GenCommitHash(&_Web3RegisterController.CallOpts, name, owner, duration, secret, resolver, data, reverseRecord, fuses, wrapperExpiry)
}
...
// LabelAvailable is a free data retrieval call binding the contract method 0xd01b0198.
//
// Solidity: function labelAvailable(bytes32 label) view returns(bool)
func (_Web3RegisterController *Web3RegisterControllerCaller) LabelAvailable(opts *bind.CallOpts, label [32]byte) (bool, error) {
	var out []interface{}
	__err := _Web3RegisterController.contract.Call(opts, &out, "labelAvailable", label)
...
//
// Solidity: function labelAvailable(bytes32 label) view returns(bool)
func (_Web3RegisterController *Web3RegisterControllerBulkCaller) LabelAvailable(bulkcaller bulk.BulkCaller, opts *bind.CallOpts, label [32]byte) (*bool, *error) {

	if opts == nil {
		opts = new(bind.CallOpts)
	}
	__request := _Web3RegisterController.contract.GenRequest(opts, "labelAvailable", label)
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _Web3RegisterController.contract.DecodeOutput(&out, rawOut, "labelAvailable")
		if err != nil {
			return err
		}
...
//
// Solidity: function labelAvailable(bytes32 label) view returns(bool)
func (_Web3RegisterController *Web3RegisterControllerSession) LabelAvailable(label [32]byte) (bool, error) {
	return _Web3RegisterController.Contract.LabelAvailable(&_Web3RegisterController.CallOpts, label)
}

// LabelAvailable is a free data retrieval call binding the contract method 0xd01b0198.
//
// Solidity: function labelAvailable(bytes32 label) view returns(bool)
func (_Web3RegisterController *Web3RegisterControllerCallerSession) LabelAvailable(label [32]byte) (bool, error) {
	return _Web3RegisterController.Contract.LabelAvailable(&_Web3RegisterController.CallOpts, label)
}

// LabelCommitments is a free data retrieval call binding the contract method 0x5dcd6a62.
//
// Solidity: function labelCommitments(bytes32 ) view returns(uint256)
func (_Web3RegisterController *Web3RegisterControllerCaller) LabelCommitments(opts *bind.CallOpts, arg0 [32]byte) (*big.Int, error) {
	var out []interface{}
	__err := _Web3RegisterController.contract.Call(opts, &out, "labelCommitments", arg0)
...
//
// Solidity: function labelCommitments(bytes32 ) view returns(uint256)
func (_Web3RegisterController *Web3RegisterControllerBulkCaller) LabelCommitments(bulkcaller bulk.BulkCaller, opts *bind.CallOpts, arg0 [32]byte) (**big.Int, *error) {

	if opts == nil {
		opts = new(bind.CallOpts)
	}
	__request := _Web3RegisterController.contract.GenRequest(opts, "labelCommitments", arg0)
	...
	outDecoder := func(rawOut []byte) error {
		out := []interface{}{}
		err := _Web3RegisterController.contract.DecodeOutput(&out, rawOut, "labelCommitments")
		if err != nil {
			return err
		}
...
//
// Solidity: function labelCommitments(bytes32 ) view returns(uint256)
func (_Web3RegisterController *Web3RegisterControllerSession) LabelCommitments(arg0 [32]byte) (*big.Int, error) {
	return _Web3RegisterController.Contract.LabelCommitments(&_Web3RegisterController.CallOpts, arg0)
}

// LabelCommitments is a free data retrieval call binding the contract method 0x5dcd6a62.
//
// Solidity: function labelCommitments(bytes32 ) view returns(uint256)
func (_Web3RegisterController *Web3RegisterControllerCallerSession) LabelCommitments(arg0 [32]byte) (*big.Int, error) {
	return _Web3RegisterController.Contract.LabelCommitments(&_Web3RegisterController.CallOpts, arg0)
}
...
func (_Web3RegisterController *Web3RegisterControllerCaller) MakeCommitment(opts *bind.CallOpts, name string, owner common.Address, duration *big.Int, secret [32]byte, resolver common.Address, data [][]byte, reverseRecord bool, fuses uint32, wrapperExpiry uint64) ([32]byte, error) {
	var out []interface{}
	__err := _Web3RegisterController.contract.Call(opts, &out, "makeCommitment", name, owner, duration, secret, resolver, data, reverseRecord, fuses, wrapperExpiry)
...
//
// Solidity: function makeCommitment(string name, address owner, uint256 duration, bytes32 secret, address resolver, bytes[] data, bool reverseRecord, uint32 fuses, uint64 wrapperExpiry) pure returns(bytes32)
func (_Web3RegisterController *Web3RegisterControllerBulkCaller) MakeCommitment(bulkcaller bulk.BulkCaller, opts *bind.CallOpts, name string, owner common.Address, duration *big.Int, secret [32]byte, resolver common.Address, data [][]byte, reverseRecord bool, fuses uint32, wrapperExpiry uint64) (*[32]byte, *error) {

	if opts == nil {
		opts = new(bind.CallOpts)
	}
	__request := _Web3RegisterController.contract.GenRequest(opts, "makeCommitment", name, owner, duration, secret, resolver, data, reverseRecord, fuses, wrapperExpiry)
...
//
// Solidity: function makeCommitment(string name, address owner, uint256 duration, bytes32 secret, address resolver, bytes[] data, bool reverseRecord, uint32 fuses, uint64 wrapperExpiry) pure returns(bytes32)
func (_Web3RegisterController *Web3RegisterControllerSession) MakeCommitment(name string, owner common.Address, duration *big.Int, secret [32]byte, resolver common.Address, data [][]byte, reverseRecord bool, fuses uint32, wrapperExpiry uint64) ([32]byte, error) {
	return _Web3RegisterController.Contract.MakeCommitment(&_Web3RegisterController.CallOpts, name, owner, duration, secret, resolver, data, reverseRecord, fuses, wrapperExpiry)
}

// MakeCommitment is a free data retrieval call binding the contract method 0xd555254a.
//
// Solidity: function makeCommitment(string name, address owner, uint256 duration, bytes32 secret, address resolver, bytes[] data, bool reverseRecord, uint32 fuses, uint64 wrapperExpiry) pure returns(bytes32)
func (_Web3RegisterController *Web3RegisterControllerCallerSession) MakeCommitment(name string, owner common.Address, duration *big.Int, secret [32]byte, resolver common.Address, data [][]byte, reverseRecord bool, fuses uint32, wrapperExpiry uint64) ([32]byte, error) {
	return _Web3RegisterController.Contract.MakeCommitment(&_Web3RegisterController.CallOpts, name, owner, duration, secret, resolver, data, reverseRecord, fuses, wrapperExpiry)
}
...
// CommitWithName is a paid mutator transaction binding the contract method 0xf15de3b8.
//
// Solidity: function commitWithName(bytes32 commitment, bytes32 label) returns()
func (_Web3RegisterController *Web3RegisterControllerTransactor) CommitWithName(opts *bind.TransactOpts, commitment [32]byte, label [32]byte) (*types.UnsignedTransaction, *types.Hash, error) {
	return _Web3RegisterController.contract.Transact(opts, "commitWithName", commitment, label)
}

// CommitWithName is a paid mutator transaction binding the contract method 0xf15de3b8.
//
// Solidity: function commitWithName(bytes32 commitment, bytes32 label) returns()
func (_Web3RegisterController *Web3RegisterControllerBulkTransactor) CommitWithName(opts *bind.TransactOpts, commitment [32]byte, label [32]byte) types.UnsignedTransaction {
	return _Web3RegisterController.contract.GenUnsignedTransaction(opts, "commitWithName", commitment, label)
}

// CommitWithName is a paid mutator transaction binding the contract method 0xf15de3b8.
//
// Solidity: function commitWithName(bytes32 commitment, bytes32 label) returns()
func (_Web3RegisterController *Web3RegisterControllerSession) CommitWithName(commitment [32]byte, label [32]byte) (*types.UnsignedTransaction, *types.Hash, error) {
	return _Web3RegisterController.Contract.CommitWithName(&_Web3RegisterController.TransactOpts, commitment, label)
}

// CommitWithName is a paid mutator transaction binding the contract method 0xf15de3b8.
//
// Solidity: function commitWithName(bytes32 commitment, bytes32 label) returns()
func (_Web3RegisterController *Web3RegisterControllerTransactorSession) CommitWithName(commitment [32]byte, label [32]byte) (*types.UnsignedTransaction, *types.Hash, error) {
	return _Web3RegisterController.Contract.CommitWithName(&_Web3RegisterController.TransactOpts, commitment, label)
}
...
func (_Web3RegisterController *Web3RegisterControllerTransactor) Register(opts *bind.TransactOpts, name string, owner common.Address, duration *big.Int, secret [32]byte, resolver common.Address, data [][]byte, reverseRecord bool, fuses uint32, wrapperExpiry uint64) (*types.UnsignedTransaction, *types.Hash, error) {
	return _Web3RegisterController.contract.Transact(opts, "register", name, owner, duration, secret, resolver, data, reverseRecord, fuses, wrapperExpiry)
}

// Register is a paid mutator transaction binding the contract method 0x7acaaf26.
//
// Solidity: function register(string name, address owner, uint256 duration, bytes32 secret, address resolver, bytes[] data, bool reverseRecord, uint32 fuses, uint64 wrapperExpiry) payable returns()
func (_Web3RegisterController *Web3RegisterControllerBulkTransactor) Register(opts *bind.TransactOpts, name string, owner common.Address, duration *big.Int, secret [32]byte, resolver common.Address, data [][]byte, reverseRecord bool, fuses uint32, wrapperExpiry uint64) types.UnsignedTransaction {
	return _Web3RegisterController.contract.GenUnsignedTransaction(opts, "register", name, owner, duration, secret, resolver, data, reverseRecord, fuses, wrapperExpiry)
}

// Register is a paid mutator transaction binding the contract method 0x7acaaf26.
//
// Solidity: function register(string name, address owner, uint256 duration, bytes32 secret, address resolver, bytes[] data, bool reverseRecord, uint32 fuses, uint64 wrapperExpiry) payable returns()
func (_Web3RegisterController *Web3RegisterControllerSession) Register(name string, owner common.Address, duration *big.Int, secret [32]byte, resolver common.Address, data [][]byte, reverseRecord bool, fuses uint32, wrapperExpiry uint64) (*types.UnsignedTransaction, *types.Hash, error) {
	return _Web3RegisterController.Contract.Register(&_Web3RegisterController.TransactOpts, name, owner, duration, secret, resolver, data, reverseRecord, fuses, wrapperExpiry)
}

// Register is a paid mutator transaction binding the contract method 0x7acaaf26.
//
// Solidity: function register(string name, address owner, uint256 duration, bytes32 secret, address resolver, bytes[] data, bool reverseRecord, uint32 fuses, uint64 wrapperExpiry) payable returns()
func (_Web3RegisterController *Web3RegisterControllerTransactorSession) Register(name string, owner common.Address, duration *big.Int, secret [32]byte, resolver common.Address, data [][]byte, reverseRecord bool, fuses uint32, wrapperExpiry uint64) (*types.UnsignedTransaction, *types.Hash, error) {
	return _Web3RegisterController.Contract.Register(&_Web3RegisterController.TransactOpts, name, owner, duration, secret, resolver, data, reverseRecord, fuses, wrapperExpiry)
}

// RegisterWithFiat is a paid mutator transaction binding the contract method 0x645b3f66.
//
// Solidity: function registerWithFiat(string name, address owner, uint256 duration, bytes32 secret, address resolver, bytes[] data, bool reverseRecord, uint32 fuses, uint64 wrapperExpiry) returns()
func (_Web3RegisterController *Web3RegisterControllerTransactor) RegisterWithFiat(opts *bind.TransactOpts, name string, owner common.Address, duration *big.Int, secret [32]byte, resolver common.Address, data [][]byte, reverseRecord bool, fuses uint32, wrapperExpiry uint64) (*types.UnsignedTransaction, *types.Hash, error) {
...
//
// Solidity: function registerWithFiat(string name, address owner, uint256 duration, bytes32 secret, address resolver, bytes[] data, bool reverseRecord, uint32 fuses, uint64 wrapperExpiry) returns()
func (_Web3RegisterController *Web3RegisterControllerBulkTransactor) RegisterWithFiat(opts *bind.TransactOpts, name string, owner common.Address, duration *big.Int, secret [32]byte, resolver common.Address, data [][]byte, reverseRecord bool, fuses uint32, wrapperExpiry uint64) types.UnsignedTransaction {
...
//
// Solidity: function registerWithFiat(string name, address owner, uint256 duration, bytes32 secret, address resolver, bytes[] data, bool reverseRecord, uint32 fuses, uint64 wrapperExpiry) returns()
func (_Web3RegisterController *Web3RegisterControllerSession) RegisterWithFiat(name string, owner common.Address, duration *big.Int, secret [32]byte, resolver common.Address, data [][]byte, reverseRecord bool, fuses uint32, wrapperExpiry uint64) (*types.UnsignedTransaction, *types.Hash, error) {
...
//
// Solidity: function registerWithFiat(string name, address owner, uint256 duration, bytes32 secret, address resolver, bytes[] data, bool reverseRecord, uint32 fuses, uint64 wrapperExpiry) returns()
func (_Web3RegisterController *Web3RegisterControllerTransactorSession) RegisterWithFiat(name string, owner common.Address, duration *big.Int, secret [32]byte, resolver common.Address, data [][]byte, reverseRecord bool, fuses uint32, wrapperExpiry uint64) (*types.UnsignedTransaction, *types.Hash, error) {
	return _Web3RegisterController.Contract.RegisterWithFiat(&_Web3RegisterController.TransactOpts, name, owner, duration, secret, resolver, data, reverseRecord, fuses, wrapperExpiry)
}
...
func (_Web3RegisterController *Web3RegisterControllerTransactor) RenewWithFuses(opts *bind.TransactOpts, name string, duration *big.Int, fuses uint32, wrapperExpiry uint64) (*types.UnsignedTransaction, *types.Hash, error) {
	return _Web3RegisterController.contract.Transact(opts, "renewWithFuses", name, duration, fuses, wrapperExpiry)
}

// RenewWithFuses is a paid mutator transaction binding the contract method 0x6459220f.
//
// Solidity: function renewWithFuses(string name, uint256 duration, uint32 fuses, uint64 wrapperExpiry) payable returns()
func (_Web3RegisterController *Web3RegisterControllerBulkTransactor) RenewWithFuses(opts *bind.TransactOpts, name string, duration *big.Int, fuses uint32, wrapperExpiry uint64) types.UnsignedTransaction {
	return _Web3RegisterController.contract.GenUnsignedTransaction(opts, "renewWithFuses", name, duration, fuses, wrapperExpiry)
}

// RenewWithFuses is a paid mutator transaction binding the contract method 0x6459220f.
//
// Solidity: function renewWithFuses(string name, uint256 duration, uint32 fuses, uint64 wrapperExpiry) payable returns()
func (_Web3RegisterController *Web3RegisterControllerSession) RenewWithFuses(name string, duration *big.Int, fuses uint32, wrapperExpiry uint64) (*types.UnsignedTransaction, *types.Hash, error) {
	return _Web3RegisterController.Contract.RenewWithFuses(&_Web3RegisterController.TransactOpts, name, duration, fuses, wrapperExpiry)
}

// RenewWithFuses is a paid mutator transaction binding the contract method 0x6459220f.
//
// Solidity: function renewWithFuses(string name, uint256 duration, uint32 fuses, uint64 wrapperExpiry) payable returns()
func (_Web3RegisterController *Web3RegisterControllerTransactorSession) RenewWithFuses(name string, duration *big.Int, fuses uint32, wrapperExpiry uint64) (*types.UnsignedTransaction, *types.Hash, error) {
	return _Web3RegisterController.Contract.RenewWithFuses(&_Web3RegisterController.TransactOpts, name, duration, fuses, wrapperExpiry)
}
